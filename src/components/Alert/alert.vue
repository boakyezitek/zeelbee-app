<template>
  ...
  <div class=" h-[80px]  bg-zeel-primary  p-6 rounded-zeel-rounded-lg" :style="styles"><span class=" text-zeel-text-small  font-zeel-regular  text-white" :style="myColor" >{{  title }}</span></div>
